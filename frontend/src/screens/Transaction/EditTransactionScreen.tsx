...
const EditTransactionScreen = () => {
  ...
  useEffect(() => {
    const loadTransaction = async () => {
      try {
        ...
        toast.showToast("Failed to load transaction details", "error");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.showToast("Failed to update transaction", "error");
    } finally {
      setSaving(false);
    }
  };
  ...
  const retryConnection = async () => {
    try {
      ...
      if (isConnected) {
        ...
        toast.showToast("Connected to the server successfully", "success");
      } else {
        toast.showToast("Cannot connect to the server", "error");
      }
    } catch (error) {
