...
const WalletScreen = () => {
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              showSuccessToast(
                "Wallet Deleted",
                "The wallet has been deleted successfully"
              );
            } catch (error) {
  ...
  const handleEditWallet = (wallet: Wallet) => {
    closeAllOpenRows();
    navigation.navigate("EditWalletScreen", { wallet: wallet });
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
          ...
          >
            ...
            <View style={styles.walletInfo}>
              ...
              <Text style={{ fontSize: 12, color: "#666", marginTop: 2 }}>
                Show transactions from all wallets
              </Text>
            </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>INCLUDED IN TOTAL</Text>
          {wallets
            .filter((wallet) => wallet.isIncludedInTotal)
            .map((wallet, index) =>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>NOT INCLUDED IN TOTAL</Text>
          {wallets
            .filter((wallet) => !wallet.isIncludedInTotal)
            .map((wallet, index) =>
